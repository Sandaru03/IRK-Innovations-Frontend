            ...
            <div className="relative">
               ...
               <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-4">
                   <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=600" alt="Tech" className="rounded-3xl shadow-lg h-64 w-full object-cover" />
                 ...
                 <div className="pt-12 space-y-4">
                   ...
                   <img src="https://images.unsplash.com/photo-1592659762303-90081d34b277?q=80&w=600" alt="Electronics" className="rounded-3xl shadow-lg h-64 w-full object-cover" />
                 </div>
               </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1">
              ...
              <Link to="/projects" className="inline-flex items-center gap-2 bg-yellow-400 text-emerald-950 font-black px-8 py-4 rounded-2xl hover:bg-white transition-all">
