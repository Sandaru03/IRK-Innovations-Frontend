...
import { Zap, Facebook, Instagram, Twitter, MapPin, Phone, Mail } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-lg overflow-hidden border border-yellow-500/50">
